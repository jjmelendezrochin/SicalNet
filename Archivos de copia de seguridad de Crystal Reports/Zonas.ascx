...
function ConfirmOperation(Button,strOperationType)
{
	...
	<table>
		...
		<tr>
			<td colSpan="2"><asp:datagrid id="dgdZonas" Width="500px" runat="server" PagerStyle-HorizontalAlign="Right" PagerStyle-Mode="NumericPages"
					AllowPaging="True" BorderStyle="None" BorderColor="White" AllowSorting="True" FontSize="11px" Font-Name="Verdana"
					AutoGenerateColumns="False" CellPadding="2" Font-Names="Verdana">
					...
					<Columns>
						<asp:TemplateColumn HeaderText="Zona">
							...
							<ItemTemplate>
								<asp:label id=ItemZona Width="50px" CssClass="standard-text" Runat="server" Text='&nbsp;<%# &#13;&#13;&#10;DataBinder.Eval(Container, "DataItem.Zona") %>'>
								</asp:label>
							</ItemTemplate>
						</asp:TemplateColumn>
