<%@ Page language="c#" Codebehind="FoliosColor1.aspx.cs" AutoEventWireup="false" Inherits="UserInterface.Forms.Structures.FoliosColor" %>
...
<HTML>
	...
	<body text="#000000" bgColor="#ffffff" leftMargin="0" topMargin="0" onload="ShowTitle()" onkeydown = "return (event.keyCode!=13)"
										...
										<tr>
											<td class="contenido" vAlign="top" width="249">
												<TABLE class="tan-border" id="Table1" height="255" cellSpacing="6" cellPadding="0" width="236"
													border="0">
													<TR vAlign="top">
														<TD class="letraAzulBold" colSpan="2" height="12">Agregar un folio de Color</TD>
													</TR>
													<TR vAlign="top">
													...
													<TR>
														...
														<td><asp:dropdownlist id="cboCodigoSAP" runat="server" CssClass="standard-text" Width="101px"></asp:dropdownlist><asp:requiredfieldvalidator id="Requiredfieldvalidator2" runat="server" ControlToValidate="cboCodigoSAP" ErrorMessage="El Código SAP es un campo requerido">*</asp:requiredfieldvalidator></td>
													</TR>
													<TR>
														<TD height="19" width="47"><asp:label id="lblMaterial" tabIndex="1" runat="server" CssClass="standard-text">Material</asp:label></TD>
														<td><asp:textbox id="txtCodigoSAP" runat="server" CssClass="standard-text" Width="128px"></asp:textbox></td>
													</TR>
													<TR vAlign="top">
													...
													<TR vAlign="top">
														<TD vAlign="middle" align="center" colSpan="2">
															<TABLE id="Table2" cellSpacing="0" cellPadding="0" border="0">
																<TR>
																	<td height="30" width="70"><asp:button id="cmdFProducto" runat="server" CssClass="botonesInput" Width="64px" Text="Agregar"
																	...
																	<TD height="30" width="70"><asp:button id="cmdCancelC" runat="server" CssClass="botonesInput" Width="64px" Text="Cancelar"
																			CausesValidation="False" tabIndex="1"></asp:button></TD>
																</TR>
															</TABLE>
														</TD>
													</TR>
