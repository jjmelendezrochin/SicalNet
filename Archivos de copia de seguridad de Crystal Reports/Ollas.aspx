												...
												<TABLE class="tan-border" id="Table1" cellSpacing="6" cellPadding="0" width="171" border="0">
													...
													<TR vAlign="top">
														...
														<td vAlign="top"><asp:textbox id="txtCapacidadMax" runat="server" CssClass="standard-text" Width="83px" MaxLength="11"></asp:textbox>
															...
															<asp:rangevalidator id="Rangevalidator2" runat="server" ErrorMessage="La capacidad máxima debe ser un número en el rango de (0-999999)" ControlToValidate="txtCapacidadMax" Type="Double" MinimumValue="1" MaximumValue="999999">*</asp:rangevalidator></td>
													</TR>
													<TR vAlign="top">
														...
														<td valign="middle"><asp:textbox id="txtCapacidadMin" runat="server" CssClass="standard-text" Width="83px" MaxLength="11"></asp:textbox>
															<asp:requiredfieldvalidator id="Requiredfieldvalidator3" runat="server" ErrorMessage="La capacidad mínima de la Olla es un campo requerido" ControlToValidate="txtCapacidadMin">*</asp:requiredfieldvalidator>
