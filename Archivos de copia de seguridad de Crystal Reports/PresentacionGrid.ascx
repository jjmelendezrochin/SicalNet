...
<P class="contenido" align="left"><asp:datagrid id="dgdPresentacion" BorderStyle="None" BorderColor="White" DataKeyField="IdPresentacion" AllowSorting="True" FontSize="11px" Font-Name="Verdana" AutoGenerateColumns="False" CellPadding="2" Font-Names="Verdana" runat="server" Width="448px" AllowPaging="True" PageSize="10" PagerStyle-Mode="NumericPages" PagerStyle-HorizontalAlign="Right">
		...
		<Columns>
			<asp:TemplateColumn HeaderText="Id">
				...
				<ItemTemplate>
					<asp:label id=ItemPresentacionId Width="40px" Runat="server" Text='&nbsp;<%# DataBinder.Eval(Container, "DataItem.IdPresentacion") %>' CssClass="standard-text">
					</asp:label>
				</ItemTemplate>
				<EditItemTemplate>
					<asp:label id=EditPresentacionId Width="40px" Runat="server" Text='&nbsp;<%# DataBinder.Eval(Container, "DataItem.IdPresentacion") %>' CssClass="standard-text">
					</asp:label>
				</EditItemTemplate>
			</asp:TemplateColumn>
