...
function ConfirmOperation(Button,strOperationType)
{
	...
	<table>
		...
		<tr>
			<td colspan="2">
				<asp:datagrid id="dgdFoliosAditivos" runat="server" Width="500px" Font-Names="Verdana" CellPadding="2"
					AutoGenerateColumns="False" Font-Name="Verdana" FontSize="11px" AllowSorting="True" BorderColor="White"
