...
<HTML>
	...
	<body MS_POSITIONING="GridLayout" onload="ShowTitle()">
		<form id="ConsultAssembleWO" method="post" runat="server">
				...
				<TBODY>
					...
					<tr>
						<td colspan="5" align="center"><br>
							<asp:Label id="lblTitle" runat="server" Font-Names="Arial Narrow" Font-Bold="True" Font-Size="14"> Ordenes de Trabajo -  Fase de Armado</asp:Label><hr>
						</td>
					</tr>
					<tr>
						<td style="HEIGHT: 10px"><asp:label id="lblFecha" style="Z-INDEX: 102" runat="server" CssClass="standard-text">Fecha Inicial</asp:label>
							<asp:label id="Label3" CssClass="standard-text" Text="(dd-MMM-yyyy)" ForeColor="Red" Runat="server"> * (dd-MMM-aaaa)</asp:label></td>
						<td style="HEIGHT: 10px"><asp:Label id="To" style="Z-INDEX: 114" runat="server" CssClass="standard-text">Fecha Final</asp:Label>
							<asp:label id="Label1" CssClass="standard-text" Text="(dd-MMM-yyyy)" ForeColor="Red" Runat="server"> * (dd-MMM-aaaa)</asp:label></td>
						<td style="HEIGHT: 10px"><asp:label id="lblLinea" style="Z-INDEX: 105" runat="server" CssClass="standard-text">Línea</asp:label></td>
						<td style="HEIGHT: 10px"><asp:label id="lblStatus" style="Z-INDEX: 106" runat="server" CssClass="standard-text">Estado</asp:label></td>
					</tr>
					<tr>
						...
						<td><asp:TextBox id="txtFechaTo" runat="server" Width="101px" CssClass="Standard-text" BorderStyle="Groove"
								MaxLength="11"></asp:TextBox>
							<asp:ImageButton id="ImgFechaTo" runat="server" ImageUrl="../../Images/icon-calendar.gif" onmouseup="GetDate('txtFechaTo');"></asp:ImageButton>
						</td>
					...
					<TR>
						...
						<TD>
							<asp:RegularExpressionValidator id="RegularExpressionValidator1" runat="server" CssClass="standard-text" ErrorMessage="Fecha incorrecta"
								ControlToValidate="txtFechaTo" ValidationExpression="(^((31(?!-(feb|abr|jun|sep|nov)))|((30|29)(?!-feb?))|(29(?=-feb?-(((1[6-9]|[2-9]\d)(0[48]|[2468][048]|[13579][26])|((16|[2468][048]|[3579][26])00)))))|(0?[1-9])|1\d|2[0-8])-(ene|feb|mar|may|abr|jul|jun|ago|oct|sep|nov|dic)-((1[6-9]|[2-9]\d)\d{2})$)|(^((31(?!-(FEB|ABR|JUN|SEP|NOV)))|((30|29)(?!-FEB?))|(29(?=-FEB?-(((1[6-9]|[2-9]\d)(0[48]|[2468][048]|[13579][26])|((16|[2468][048]|[3579][26])00)))))|(0?[1-9])|1\d|2[0-8])-(ENE|FEB|MAR|MAY|ABR|JUL|JUN|AGO|OCT|SEP|NOV|DIC)-((1[6-9]|[2-9]\d)\d{2})$)|(^((31(?!-(Feb|Abr|Jun|Sep|Nov)))|((30|29)(?!-Feb?))|(29(?=-Feb?-(((1[6-9]|[2-9]\d)(0[48]|[2468][048]|[13579][26])|((16|[2468][048]|[3579][26])00)))))|(0?[1-9])|1\d|2[0-8])-(Ene|Feb|Mar|May|Abr|Jul|Jun|Ago|Oct|Sep|Nov|Dic)-((1[6-9]|[2-9]\d)\d{2})$)"
								Display="Dynamic"></asp:RegularExpressionValidator></TD>
						<TD></TD>
						<TD></TD>
						<TD></TD>
								...
								<Columns>
									...
									<asp:TemplateColumn HeaderText="Descripci&#243;n">
										...
										<ItemTemplate>
											...
											<asp:label id=ItemDescFamiliaProducto CssClass="standard-text" Text='<%# DataBinder.Eval(Container, "DataItem.DescFamiliaProducto") %>' Runat="server" Visible="False">
											</asp:label>
										</ItemTemplate>
									</asp:TemplateColumn>
