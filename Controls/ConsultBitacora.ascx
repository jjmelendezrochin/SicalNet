					...
					<TR vAlign=top>
						<TD align=center>
							<TABLE id=Table2>
								<TR>
									<TD colSpan=2>
										<asp:label id=lblDate Runat="server" Text="Fecha del Programma"
											CssClass="standard-text">Fecha de la Bitacora</asp:label>
										<asp:label id=Label3 Runat="server" Text="(dd-MMM-yyyy)"
											CssClass="standard-text" ForeColor="Red"> * (dd-MMM-aaaa)</asp:label>
									</TD>
								</TR>
								<TR>
									<TD>
										<asp:textbox id=txtFecha Runat="server" CssClass="Standard-text" MaxLength="11"
											Width="100px" BorderStyle="Groove" OnTextChanged="txtFecha_TextChanged">
										</asp:textbox>
										<asp:image onmouseup=GetDate(); id=imgInitial Runat="server"
											AlternateText="Inicial Date" ImageUrl="../Images/icon-calendar.gif">
										</asp:image><br>
										<asp:regularexpressionvalidator id=revFecha CssClass="standard-text"
											Display="Dynamic"
											...
											ControlToValidate="txtFecha" ErrorMessage="Fecha incorrecta" runat="server">
										</asp:regularexpressionvalidator>
									</TD>
									<TD>
										<asp:textbox id=txtFechaFin Runat="server" CssClass="Standard-text"
											MaxLength="11" Width="100px" BorderStyle="Groove"></asp:textbox>
										<asp:image onmouseup=GetDate2(); id=imgFin Runat="server"
											AlternateText="Final Date" ImageUrl="../Images/icon-calendar.gif">
										</asp:image><br>
										<asp:regularexpressionvalidator id=Regularexpressionvalidator1
											CssClass="standard-text" Display="Dynamic"
											ValidationExpression="(^((31(?!-(feb|abr|jun|sep|nov)))|((30|29)(?!-feb?))|(29(?=-feb?-(((1[6-9]|[2-9]\d)(0[48]|[2468][048]|[13579][26])|((16|[2468][048]|[3579][26])00)))))|(0?[1-9])|1\d|2[0-8])-(ene|feb|mar|may|abr|jul|jun|ago|oct|sep|nov|dic)-((1[6-9]|[2-9]\d)\d{2})$)|(^((31(?!-(FEB|ABR|JUN|SEP|NOV)))|((30|29)(?!-FEB?))|(29(?=-FEB?-(((1[6-9]|[2-9]\d)(0[48]|[2468][048]|[13579][26])|((16|[2468][048]|[3579][26])00)))))|(0?[1-9])|1\d|2[0-8])-(ENE|FEB|MAR|MAY|ABR|JUL|JUN|AGO|OCT|SEP|NOV|DIC)-((1[6-9]|[2-9]\d)\d{2})$)|(^((31(?!-(Feb|Abr|Jun|Sep|Nov)))|((30|29)(?!-Feb?))|(29(?=-Feb?-(((1[6-9]|[2-9]\d)(0[48]|[2468][048]|[13579][26])|((16|[2468][048]|[3579][26])00)))))|(0?[1-9])|1\d|2[0-8])-(Ene|Feb|Mar|May|Abr|Jul|Jun|Ago|Oct|Sep|Nov|Dic)-((1[6-9]|[2-9]\d)\d{2})$)"
											ControlToValidate="txtFechaFin" ErrorMessage="Fecha incorrecta"
											runat="server"></asp:regularexpressionvalidator>
									</TD>
								</TR>
								<TR>
									<TD align=center colSpan=2>
										<asp:button id=btnSel Runat="server" Text="Aceptar" CssClass="botonesInput"
											OnClick="btnSel_Click1" style="width: 105px"></asp:button>
									</TD>
								</TR>
							</TABLE>
						</TD>
