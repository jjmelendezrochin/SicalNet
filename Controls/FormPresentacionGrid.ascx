<%@ Control Language="c#" AutoEventWireup="false" Codebehind="FormPresentacionGrid.ascx.cs" Inherits="UserInterface.Controls.FormPresentacionGrid" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
...
<P class="contenido" align="left"><asp:datagrid id="dgdFormPresentacion" BorderStyle="None" BorderColor="White" AllowSorting="True"
		FontSize="11px" Font-Name="Verdana" AutoGenerateColumns="False" CellPadding="2" Font-Names="Verdana" runat="server" Width="650px"
		AllowPaging="True" PageSize="10" PagerStyle-Mode="NumericPages" PagerStyle-HorizontalAlign="Right"  CssClass="GridView grid-users">
		...
		<Columns>
			...
			<asp:TemplateColumn HeaderText="Unidad">
				...
				<ItemStyle Width="100px" CssClass="grid-item"></ItemStyle>
				<ItemTemplate>
					<asp:label id=ItemUnidad Runat="server" Text='<%#DataBinder.Eval(Container, "DataItem.DescripcionUnidad") %>' CssClass="standard-text">
					</asp:label>
				</ItemTemplate>
				<EditItemTemplate>
