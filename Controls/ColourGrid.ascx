...
<P class="contenido" align="left">
	<asp:datagrid id="dgdColour" AllowPaging="True" PageSize="10" BorderStyle="None" BorderColor="White"
		DataKeyField="IdColour" AllowSorting="True" FontSize="11px" Font-Name="Verdana" 
		AutoGenerateColumns="False" CellPadding="2"
		Font-Names="Verdana" runat="server" CssClass="GridView grid-header">
