			...
			<table width="860" align="center">
				<tr>
					<td colspan="6" align="center">
						<asp:Label id="lblTitle" runat="server" Font-Names="Arial Narrow" Font-Bold="True" Font-Size="14">Reporte por UTEC</asp:Label><hr>
					</td>
				</tr>
				<tr>
					<td>
					...
					<td>
						...
						<asp:textbox id="txtLibInicial" runat="server" Width="128px" CssClass="Standard-text" BorderStyle="Groove"
							MaxLength="11"></asp:textbox>
						<asp:imagebutton id="Imagebutton1" runat="server" ImageUrl="../../Images/icon-calendar.gif" OnClientClick="return GetDate(document.forms[0].elements['txtLibInicial'].value,'txtLibInicial');"></asp:imagebutton>
					</td>
				</tr>
				<TR>
					<TD></TD>
