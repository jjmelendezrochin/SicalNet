								...
								<table border="0" cellSpacing="0" cellPadding="0" width="700">
									<TBODY>
										<tr>
											<td width="213">&nbsp;</td>
											<TD width="10"></TD>
											<td><span class="letraAzulBold"></span></td>
										</tr>
										<tr>
											<td class="contenido" vAlign="top" width="213">
												<TABLE style="Z-INDEX: 0" id="Table1"  border="0" cellSpacing="6" cellPadding="0"
													...
													<TR>
														...
														<td height="7">
															<asp:dropdownlist id="cboLinea" runat="server" CssClass="standard-text" AutoPostBack="True" Width="100%">
														               </asp:dropdownlist>
														</td>
													</TR>
													<TR>
													...
													<TR>
														<td align="center">
															<asp:button id="cmdFProducto" runat="server" CssClass="botonesInput" Width="80px" Text="Agregar"></asp:button></td>
														<TD lign="center">
											...
											<td class="contenido" vAlign="top">
												...
												<P class="contenido" align="left">
													<TABLE id="Table3"  border="0" cellSpacing="12" cellPadding="0" width="800px"
														height="99">
														<TBODY>
															<TR vAlign="top">
																<TD>
