...
{
	/// <summary>
	/// Summary description for ConsultSeparacionWO.
	/// </summary>
	public class ConsultSeparacionWO : System.Web.UI.Page
	{
		...
		private void cmdAceptar_Click(object sender, System.EventArgs e)
		{
			...
			string FechaTo = txtFechaFinal.Text;
		...
		private void dgdWorkOrder_ItemCommand(object source, System.Web.UI.WebControls.DataGridCommandEventArgs e)
		{
			if (e.CommandName=="Consult")
			{
				try
				{
					...
					{
						string Secuencia, Fecha, UTEC, FamiliaDesc, LineaDesc,CodigoSAP;
						int Cantidad;
						...
						FamiliaDesc = ((Label)e.Item.FindControl("ItemFamiliaDesc")).Text;
						LineaDesc = ((Label)e.Item.FindControl("ItemLineaDesc")).Text;
						//Status = ((Label)e.Item.FindControl("ItemIdStatus")).Text;
						CodigoSAP=((Label)e.Item.FindControl("ItemCodigoSAP")).Text;
											
						Response.Redirect("ConsultSeparacionWO1.aspx?Secuencia=" + Secuencia 
							+ "&Fecha=" + Fecha 							
							+ "&Cantidad=" + Cantidad 
