...
<HTML>
	<HEAD>
		<title>SICAL - Cuarto de PVC</title>
	...
	<body MS_POSITIONING="GridLayout" onload="ShowTitle()">
		<form id="ConsultPVCWO" method="post" runat="server">
			<table align="center" style="BORDER-COLLAPSE: collapse">
				...
				<TR>
					<TD align="center" colSpan="5" height="40"><br>
						<asp:label id="lblTitle" runat="server" Font-Names="Arial Narrow" Font-Size="14" Font-Bold="True">Ordenes de Trabajo - Fase de PVC</asp:label><HR>
					</TD>
				</TR>
				<TR>
					<TD><asp:label id="lblFecha" runat="server" CssClass="standard-text">Fecha Inicial</asp:label>
						<asp:label id="Label4" CssClass="standard-text" Text="(dd-MMM-yyyy)" Runat="server" ForeColor="Red"> * (dd-MMM-aaaa)</asp:label></TD>
					...
					<TD><asp:label id="lblLinea" runat="server" CssClass="standard-text">Línea Producción</asp:label></TD>
				...
				<TR>
					<TD align="center" colSpan="5"><asp:datagrid id="dgdWorkOrder" runat="server" Width="750px" BorderStyle="None" AllowSorting="True"
							FontSize="11px" Font-Name="Verdana" AutoGenerateColumns="False" BorderColor="White" CellPadding="2" Font-Names="Verdana"
							CssClass="contenidoTablas">
