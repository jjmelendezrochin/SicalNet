...
{
	/// <summary>
	/// Summary description for AditivosWORpt1.
	/// </summary>
	public class AditivosWORpt1 : System.Web.UI.Page
	{
		protected CrystalDecisions.Web.CrystalReportViewer AditivosRpt;
		UserInterface.Forms.Production.AditivosWORpt crReportDocument;
		Database crDatabase;
		Tables crTables;
		...
		override protected void OnInit(EventArgs e)
		{
			...
			pdv.Value = "Programa : Del "+Request.QueryString["FechaIni"] + " al " + Request.QueryString["FechaFin"];
			Fecha.CurrentValues.Add(pdv);

			ParamFields.Add(Fecha);

			AditivosRpt.ParameterFieldInfo = ParamFields;
			...
			AditivosRpt.SelectionFormula = SelectionStr+" AND {OrdenesTrabajo.IdArea}=2 AND "+Request.QueryString["Secuencias"];
			AditivosRpt.ReportSource = crReportDocument;
			AditivosRpt.DisplayGroupTree=false;
		}
