...
namespace UserInterface.Forms.Production
{
	...
	public class UnLiberer : System.Web.UI.Page
	{
		...
		private void btnUnLiberer_Click(object sender, System.EventArgs e)
		{
			...
			{
				MessageDisplay(
					"Por favor, indique el número de secuencia que desea reactivar.",
					"warning",
					"Secuencia requerida"
				);
				return;
			...
			{
				MessageDisplay(
					string.Format("Por favor, indique el área o las áreas donde desea reactivar la secuencia -{0}-.", selectedSequence),
					"warning",
					"Área requerida"
				);
			}
