		...
		<script language="javascript">	
			...
			function getConfirmQuarentine(Button)
				...
				SicalAlert.confirmar(
					"¿Estás seguro que deseas liberar la secuencia a fase de Pendientes/Cuarentena?",
			...
			function getConfirmEnvio(Button)
			{
                ...
                SicalAlert.confirmar(
                    "¿Estás seguro que deseas liberar la secuencia a la fase de Envío de Producto Terminado?",
                    "Confirmar liberación",
                    function () {
                        btn.setAttribute("data-confirmado", "1");
                        btn.click();
