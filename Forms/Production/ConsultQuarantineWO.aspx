...
<%@ Page language="c#" Codebehind="ConsultQuarantineWO.aspx.cs" AutoEventWireup="false" Inherits="UserInterface.Forms.Production.ConsultQuarantineWO" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>ConsultQuarantineWO</title>
		...
		<script language="javascript">		
			...
			function ShowTitle()
			{
					window.frames["top"].document.title = "SICAL  -Ordenes de Trabajo - Fase de Cuarentena"
			}			
		</script>
	</HEAD>
	<body MS_POSITIONING="GridLayout" onload="ShowTitle()">
		<form id="ConsultQuarantineWO" method="post" runat="server">
			<table align="center" style="BORDER-COLLAPSE: collapse">
				...
				<tr>
					<td colspan="5" align="center"><br>
						<asp:Label id="lblTitle" runat="server" Font-Names="Arial Narrow" Font-Bold="True" Font-Size="14">Ordenes de Trabajo - Fase de Pendientes/Cuarentena</asp:Label><hr>
					</td>
				</tr>
				<tr>
					<td><asp:label id="lblFecha" runat="server" CssClass="standard-text">Fecha Inicial</asp:label>
						<asp:label id="Label3" Text="(dd-MMM-yyyy)" Runat="server" ForeColor="Red" CssClass="standard-text"> * (dd-MMM-aaaa)</asp:label></td>
					<td><asp:label id="lblFechaFinal" runat="server" CssClass="standard-text">Fecha Final</asp:label>
						<asp:label id="Label1" Text="(dd-MMM-yyyy)" Runat="server" ForeColor="Red" CssClass="standard-text"> * (dd-MMM-aaaa)</asp:label></td>
				...
				<tr>
					<td style="HEIGHT: 14px"><asp:textbox id="txtFecha" runat="server" CssClass="standard-text" BorderStyle="Groove" MaxLength="11"></asp:textbox>
						<asp:imagebutton id="cmdCalendar" runat="server" ImageUrl="../../Images/icon-calendar.gif" onmouseup="GetDate('txtFecha')"></asp:imagebutton></td>
					<td style="HEIGHT: 14px"><asp:textbox id="txtFechaFinal" runat="server" CssClass="standard-text" BorderStyle="Groove"
							MaxLength="11"></asp:textbox>
						<asp:imagebutton id="ImgFechaFinal" runat="server" ImageUrl="../../Images/icon-calendar.gif" onmouseup="GetDate('txtFechaFinal')"></asp:imagebutton></td>
				...
				<tr>
					<td colspan="5" align="center">
						<asp:datagrid id="dgdWorkOrder" runat="server" Width="770px" BorderColor="White" CellPadding="2"
							Font-Names="Verdana" AutoGenerateColumns="False" Font-Name="Verdana" FontSize="11px" AllowSorting="True"
							BorderStyle="None">
							...
							<Columns>
								...
								<asp:TemplateColumn HeaderText="Descripci&#243;n">
									...
									<ItemTemplate>
										...
										<asp:label id=ItemFamiliaProducto CssClass="standard-text" Text='<%# DataBinder.Eval(Container, "DataItem.IdFamiliaProducto") %>' Runat="server" Visible="False">
										</asp:label>
										<asp:label id=ItemDescFamilia CssClass="standard-text" Text='<%# DataBinder.Eval(Container, "DataItem.DescFamiliaProducto") %>' Runat="server" Visible="False">
										</asp:label>
				...
				<tr>
					<td colspan="5">
						<asp:label id="lblErrorMsg" ForeColor="Red" Runat="server" Font-Bold="True" CssClass="standard-text"></asp:label>
					</td>
				</tr>
			</table>
		</form>
