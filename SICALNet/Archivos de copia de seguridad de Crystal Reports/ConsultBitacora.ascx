        ...
        <TR vAlign=top>
          <TD align=center>
            <TABLE id=Table2>
              ...
              <TR>
                <TD><asp:textbox id=txtFecha Runat="server" CssClass="Standard-text" MaxLength="11" Width="77px" BorderStyle="Groove"></asp:textbox><asp:image onmouseup=GetDate(); id=imgInitial Runat="server" AlternateText="Inicial Date" ImageUrl="../Images/icon-calendar.gif"></asp:image><br 
              ...
              <TR>
                <TD align=center colSpan=2><asp:button id=btnSel Runat="server" Text="Aceptar" CssClass="botonesInput"></asp:button></TD></TR></TABLE></TD></TR>
        <TR>
