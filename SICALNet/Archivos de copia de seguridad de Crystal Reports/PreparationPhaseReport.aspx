<%@ Page language="c#" Codebehind="PreparationPhaseReport.aspx.cs" AutoEventWireup="false" Inherits="UserInterface.Forms.Reports.PreparationPhaseReport" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>PreparationPhaseReport</title>
	...
	<body MS_POSITIONING="GridLayout">
		<form id="ConsultReport" method="post" runat="server">
			<asp:Label id="lblcaption" Runat="server" style="Z-INDEX: 103; LEFT: 184px; POSITION: absolute; TOP: 13px"
				Font-Bold="True" Font-Size="Larger" CssClass="standard-text" Width="504px"> Reporte de Consumos en Fase de Preseparación </asp:Label>
			<asp:ValidationSummary id="vs" style="Z-INDEX: 136; LEFT: 16px; POSITION: absolute; TOP: 208px" runat="server"
				Width="216px" CssClass="standard-text"></asp:ValidationSummary>
			<asp:RegularExpressionValidator id="RegularExpressionValidator3" style="Z-INDEX: 135; LEFT: 824px; POSITION: absolute; TOP: 168px"
				runat="server" CssClass="standard-text" ErrorMessage="Fecha incorrecta en liberación final" ControlToValidate="TxtLiberacion2"
			...
			<asp:RegularExpressionValidator id="RegularExpressionValidator2" style="Z-INDEX: 134; LEFT: 824px; POSITION: absolute; TOP: 88px"
				runat="server" CssClass="standard-text" ErrorMessage="Fecha incorrecta en liberación inicial" ControlToValidate="TxtLiberacion1"
				ValidationExpression="(^((31(?!-(feb|abr|jun|sep|nov)))|((30|29)(?!-feb?))|(29(?=-feb?-(((1[6-9]|[2-9]\d)(0[48]|[2468][048]|[13579][26])|((16|[2468][048]|[3579][26])00)))))|(0?[1-9])|1\d|2[0-8])-(ene|feb|mar|may|abr|jul|jun|ago|oct|sep|nov|dic)-((1[6-9]|[2-9]\d)\d{2})$)|(^((31(?!-(FEB|ABR|JUN|SEP|NOV)))|((30|29)(?!-FEB?))|(29(?=-FEB?-(((1[6-9]|[2-9]\d)(0[48]|[2468][048]|[13579][26])|((16|[2468][048]|[3579][26])00)))))|(0?[1-9])|1\d|2[0-8])-(ENE|FEB|MAR|MAY|ABR|JUL|JUN|AGO|OCT|SEP|NOV|DIC)-((1[6-9]|[2-9]\d)\d{2})$)|(^((31(?!-(Feb|Abr|Jun|Sep|Nov)))|((30|29)(?!-Feb?))|(29(?=-Feb?-(((1[6-9]|[2-9]\d)(0[48]|[2468][048]|[13579][26])|((16|[2468][048]|[3579][26])00)))))|(0?[1-9])|1\d|2[0-8])-(Ene|Feb|Mar|May|Abr|Jul|Jun|Ago|Oct|Sep|Nov|Dic)-((1[6-9]|[2-9]\d)\d{2})$)">*</asp:RegularExpressionValidator>
			<asp:RegularExpressionValidator id="RegularExpressionValidator1" style="Z-INDEX: 133; LEFT: 656px; POSITION: absolute; TOP: 168px"
				runat="server" CssClass="standard-text" ErrorMessage="Fecha incorrecta en programa final" ControlToValidate="TxtFechaPrograma2"
				ValidationExpression="(^((31(?!-(feb|abr|jun|sep|nov)))|((30|29)(?!-feb?))|(29(?=-feb?-(((1[6-9]|[2-9]\d)(0[48]|[2468][048]|[13579][26])|((16|[2468][048]|[3579][26])00)))))|(0?[1-9])|1\d|2[0-8])-(ene|feb|mar|may|abr|jul|jun|ago|oct|sep|nov|dic)-((1[6-9]|[2-9]\d)\d{2})$)|(^((31(?!-(FEB|ABR|JUN|SEP|NOV)))|((30|29)(?!-FEB?))|(29(?=-FEB?-(((1[6-9]|[2-9]\d)(0[48]|[2468][048]|[13579][26])|((16|[2468][048]|[3579][26])00)))))|(0?[1-9])|1\d|2[0-8])-(ENE|FEB|MAR|MAY|ABR|JUL|JUN|AGO|OCT|SEP|NOV|DIC)-((1[6-9]|[2-9]\d)\d{2})$)|(^((31(?!-(Feb|Abr|Jun|Sep|Nov)))|((30|29)(?!-Feb?))|(29(?=-Feb?-(((1[6-9]|[2-9]\d)(0[48]|[2468][048]|[13579][26])|((16|[2468][048]|[3579][26])00)))))|(0?[1-9])|1\d|2[0-8])-(Ene|Feb|Mar|May|Abr|Jul|Jun|Ago|Oct|Sep|Nov|Dic)-((1[6-9]|[2-9]\d)\d{2})$)">*</asp:RegularExpressionValidator>
			<asp:RegularExpressionValidator id="revInitial" style="Z-INDEX: 132; LEFT: 656px; POSITION: absolute; TOP: 88px"
				runat="server" CssClass="standard-text" ErrorMessage="Fecha incorrecta en programa inicial" ControlToValidate="TxtFechaPrograma1"
				ValidationExpression="(^((31(?!-(feb|abr|jun|sep|nov)))|((30|29)(?!-feb?))|(29(?=-feb?-(((1[6-9]|[2-9]\d)(0[48]|[2468][048]|[13579][26])|((16|[2468][048]|[3579][26])00)))))|(0?[1-9])|1\d|2[0-8])-(ene|feb|mar|may|abr|jul|jun|ago|oct|sep|nov|dic)-((1[6-9]|[2-9]\d)\d{2})$)|(^((31(?!-(FEB|ABR|JUN|SEP|NOV)))|((30|29)(?!-FEB?))|(29(?=-FEB?-(((1[6-9]|[2-9]\d)(0[48]|[2468][048]|[13579][26])|((16|[2468][048]|[3579][26])00)))))|(0?[1-9])|1\d|2[0-8])-(ENE|FEB|MAR|MAY|ABR|JUL|JUN|AGO|OCT|SEP|NOV|DIC)-((1[6-9]|[2-9]\d)\d{2})$)|(^((31(?!-(Feb|Abr|Jun|Sep|Nov)))|((30|29)(?!-Feb?))|(29(?=-Feb?-(((1[6-9]|[2-9]\d)(0[48]|[2468][048]|[13579][26])|((16|[2468][048]|[3579][26])00)))))|(0?[1-9])|1\d|2[0-8])-(Ene|Feb|Mar|May|Abr|Jul|Jun|Ago|Oct|Sep|Nov|Dic)-((1[6-9]|[2-9]\d)\d{2})$)">*</asp:RegularExpressionValidator>
			...
			<asp:label id="lblFechaPrograma12" style="Z-INDEX: 107; LEFT: 520px; POSITION: absolute; TOP: 139px"
				runat="server" Width="140px" Height="22px" CssClass="standard-text"> Fecha Programa Final</asp:label>
			...
			<asp:label id="LblLiberacion2" style="Z-INDEX: 111; LEFT: 688px; POSITION: absolute; TOP: 139px"
				runat="server" Width="143px" Height="22px" CssClass="standard-text">Fecha Liberación Final</asp:label>
			...
			<asp:label id="LblLiberacion1" style="Z-INDEX: 113; LEFT: 688px; POSITION: absolute; TOP: 60px"
				runat="server" Width="152px" Height="22px" CssClass="standard-text">Fecha Liberación inicial</asp:label>
